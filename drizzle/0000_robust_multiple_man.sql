...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "work-diplom_session" (
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "work-diplom_session" ADD CONSTRAINT "work-diplom_session_user_id_work-diplom_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."work-diplom_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "account_user_id_idx" ON "work-diplom_account" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "session_user_id_idx" ON "work-diplom_session" USING btree ("user_id");